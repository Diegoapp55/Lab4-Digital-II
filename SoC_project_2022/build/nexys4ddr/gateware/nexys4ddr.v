...
reg  csrbank3_r_enable0_re = 1'd0;
wire csrbank3_r_enable0_r;
reg  csrbank3_r_enable0_we = 1'd0;
wire csrbank3_r_enable0_w;
reg  csrbank3_r_width0_re = 1'd0;
wire [31:0] csrbank3_r_width0_r;
reg  csrbank3_r_width0_we = 1'd0;
wire [31:0] csrbank3_r_width0_w;
reg  csrbank3_r_period0_re = 1'd0;
wire [31:0] csrbank3_r_period0_r;
reg  csrbank3_r_period0_we = 1'd0;
wire [31:0] csrbank3_r_period0_w;
reg  csrbank3_g_enable0_re = 1'd0;
wire csrbank3_g_enable0_r;
reg  csrbank3_g_enable0_we = 1'd0;
wire csrbank3_g_enable0_w;
reg  csrbank3_g_width0_re = 1'd0;
wire [31:0] csrbank3_g_width0_r;
reg  csrbank3_g_width0_we = 1'd0;
wire [31:0] csrbank3_g_width0_w;
reg  csrbank3_g_period0_re = 1'd0;
wire [31:0] csrbank3_g_period0_r;
reg  csrbank3_g_period0_we = 1'd0;
wire [31:0] csrbank3_g_period0_w;
reg  csrbank3_b_enable0_re = 1'd0;
wire csrbank3_b_enable0_r;
reg  csrbank3_b_enable0_we = 1'd0;
wire csrbank3_b_enable0_w;
reg  csrbank3_b_width0_re = 1'd0;
wire [31:0] csrbank3_b_width0_r;
reg  csrbank3_b_width0_we = 1'd0;
wire [31:0] csrbank3_b_width0_w;
reg  csrbank3_b_period0_re = 1'd0;
wire [31:0] csrbank3_b_period0_r;
reg  csrbank3_b_period0_we = 1'd0;
wire [31:0] csrbank3_b_period0_w;
wire csrbank3_sel;
...
wire [15:0] csrbank5_out0_r;
reg  csrbank5_out0_we = 1'd0;
wire [15:0] csrbank5_out0_w;
wire csrbank5_sel;
...
wire [15:0] csrbank6_in_r;
reg  csrbank6_in_we = 1'd0;
wire [15:0] csrbank6_in_w;
wire csrbank6_sel;
...
assign {led15, led14, led13, led12, led11, led10, led9, led8, led7, led6, led5, led4, led3, led2, led1, led0} = leds_storage;
...
assign csrbank3_r_enable0_r = interface3_bank_bus_dat_w[0];
always @(*) begin
	csrbank3_r_enable0_re <= 1'd0;
	csrbank3_r_enable0_we <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank3_r_enable0_re <= interface3_bank_bus_we;
		csrbank3_r_enable0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_r_width0_r = interface3_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank3_r_width0_we <= 1'd0;
	csrbank3_r_width0_re <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank3_r_width0_re <= interface3_bank_bus_we;
		csrbank3_r_width0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_r_period0_r = interface3_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank3_r_period0_re <= 1'd0;
	csrbank3_r_period0_we <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank3_r_period0_re <= interface3_bank_bus_we;
		csrbank3_r_period0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_g_enable0_r = interface3_bank_bus_dat_w[0];
always @(*) begin
	csrbank3_g_enable0_we <= 1'd0;
	csrbank3_g_enable0_re <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 2'd3))) begin
		csrbank3_g_enable0_re <= interface3_bank_bus_we;
		csrbank3_g_enable0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_g_width0_r = interface3_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank3_g_width0_we <= 1'd0;
	csrbank3_g_width0_re <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 3'd4))) begin
		csrbank3_g_width0_re <= interface3_bank_bus_we;
		csrbank3_g_width0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_g_period0_r = interface3_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank3_g_period0_re <= 1'd0;
	csrbank3_g_period0_we <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 3'd5))) begin
		csrbank3_g_period0_re <= interface3_bank_bus_we;
		csrbank3_g_period0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_b_enable0_r = interface3_bank_bus_dat_w[0];
always @(*) begin
	csrbank3_b_enable0_we <= 1'd0;
	csrbank3_b_enable0_re <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 3'd6))) begin
		csrbank3_b_enable0_re <= interface3_bank_bus_we;
		csrbank3_b_enable0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_b_width0_r = interface3_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank3_b_width0_re <= 1'd0;
	csrbank3_b_width0_we <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 3'd7))) begin
		csrbank3_b_width0_re <= interface3_bank_bus_we;
		csrbank3_b_width0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_b_period0_r = interface3_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank3_b_period0_re <= 1'd0;
	csrbank3_b_period0_we <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 4'd8))) begin
		csrbank3_b_period0_re <= interface3_bank_bus_we;
		csrbank3_b_period0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_r_enable0_w = ledRGB_1_r_enable_storage;
assign csrbank3_r_width0_w = ledRGB_1_r_width_storage[31:0];
assign csrbank3_r_period0_w = ledRGB_1_r_period_storage[31:0];
assign csrbank3_g_enable0_w = ledRGB_1_g_enable_storage;
assign csrbank3_g_width0_w = ledRGB_1_g_width_storage[31:0];
assign csrbank3_g_period0_w = ledRGB_1_g_period_storage[31:0];
assign csrbank3_b_enable0_w = ledRGB_1_b_enable_storage;
assign csrbank3_b_width0_w = ledRGB_1_b_width_storage[31:0];
assign csrbank3_b_period0_w = ledRGB_1_b_period_storage[31:0];
...
assign csrbank4_r_enable0_w = ledRGB_2_r_enable_storage;
assign csrbank4_r_width0_w = ledRGB_2_r_width_storage[31:0];
assign csrbank4_r_period0_w = ledRGB_2_r_period_storage[31:0];
assign csrbank4_g_enable0_w = ledRGB_2_g_enable_storage;
assign csrbank4_g_width0_w = ledRGB_2_g_width_storage[31:0];
assign csrbank4_g_period0_w = ledRGB_2_g_period_storage[31:0];
assign csrbank4_b_enable0_w = ledRGB_2_b_enable_storage;
assign csrbank4_b_width0_w = ledRGB_2_b_width_storage[31:0];
assign csrbank4_b_period0_w = ledRGB_2_b_period_storage[31:0];
assign csrbank5_sel = (interface5_bank_bus_adr[13:9] == 1'd0);
assign csrbank5_out0_r = interface5_bank_bus_dat_w[15:0];
always @(*) begin
...
assign csrbank5_out0_w = leds_storage[15:0];
assign csrbank6_sel = (interface6_bank_bus_adr[13:9] == 1'd1);
assign csrbank6_in_r = interface6_bank_bus_dat_w[15:0];
always @(*) begin
	csrbank6_in_we <= 1'd0;
	csrbank6_in_re <= 1'd0;
...
assign csrbank6_in_w = switchs_status[15:0];
...
assign xilinxmultiregimpl1 = {sw15, sw14, sw13, sw12, sw11, sw10, sw9, sw8, sw7, sw6, sw5, sw4, sw3, sw2, sw1, sw0};
...
always @(posedge sys_clk) begin
	...
	if (csrbank3_sel) begin
		case (interface3_bank_bus_adr[8:0])
			1'd0: begin
				interface3_bank_bus_dat_r <= csrbank3_r_enable0_w;
			end
			1'd1: begin
				interface3_bank_bus_dat_r <= csrbank3_r_width0_w;
			end
			2'd2: begin
				interface3_bank_bus_dat_r <= csrbank3_r_period0_w;
			end
			2'd3: begin
				interface3_bank_bus_dat_r <= csrbank3_g_enable0_w;
			end
			3'd4: begin
				interface3_bank_bus_dat_r <= csrbank3_g_width0_w;
			end
			3'd5: begin
				interface3_bank_bus_dat_r <= csrbank3_g_period0_w;
			end
			3'd6: begin
				interface3_bank_bus_dat_r <= csrbank3_b_enable0_w;
			end
			3'd7: begin
				interface3_bank_bus_dat_r <= csrbank3_b_width0_w;
			end
			4'd8: begin
				interface3_bank_bus_dat_r <= csrbank3_b_period0_w;
			end
		endcase
	end
	if (csrbank3_r_enable0_re) begin
		ledRGB_1_r_enable_storage <= csrbank3_r_enable0_r;
	end
	ledRGB_1_r_enable_re <= csrbank3_r_enable0_re;
	if (csrbank3_r_width0_re) begin
		ledRGB_1_r_width_storage[31:0] <= csrbank3_r_width0_r;
	end
	ledRGB_1_r_width_re <= csrbank3_r_width0_re;
	if (csrbank3_r_period0_re) begin
		ledRGB_1_r_period_storage[31:0] <= csrbank3_r_period0_r;
	end
	ledRGB_1_r_period_re <= csrbank3_r_period0_re;
	if (csrbank3_g_enable0_re) begin
		ledRGB_1_g_enable_storage <= csrbank3_g_enable0_r;
	end
	ledRGB_1_g_enable_re <= csrbank3_g_enable0_re;
	if (csrbank3_g_width0_re) begin
		ledRGB_1_g_width_storage[31:0] <= csrbank3_g_width0_r;
	end
	ledRGB_1_g_width_re <= csrbank3_g_width0_re;
	if (csrbank3_g_period0_re) begin
		ledRGB_1_g_period_storage[31:0] <= csrbank3_g_period0_r;
	end
	ledRGB_1_g_period_re <= csrbank3_g_period0_re;
	if (csrbank3_b_enable0_re) begin
		ledRGB_1_b_enable_storage <= csrbank3_b_enable0_r;
	end
	ledRGB_1_b_enable_re <= csrbank3_b_enable0_re;
	if (csrbank3_b_width0_re) begin
		ledRGB_1_b_width_storage[31:0] <= csrbank3_b_width0_r;
	end
	ledRGB_1_b_width_re <= csrbank3_b_width0_re;
	if (csrbank3_b_period0_re) begin
		ledRGB_1_b_period_storage[31:0] <= csrbank3_b_period0_r;
	end
	ledRGB_1_b_period_re <= csrbank3_b_period0_re;
	...
	if (csrbank4_r_enable0_re) begin
		ledRGB_2_r_enable_storage <= csrbank4_r_enable0_r;
	end
	ledRGB_2_r_enable_re <= csrbank4_r_enable0_re;
	if (csrbank4_r_width0_re) begin
		ledRGB_2_r_width_storage[31:0] <= csrbank4_r_width0_r;
	end
	ledRGB_2_r_width_re <= csrbank4_r_width0_re;
	if (csrbank4_r_period0_re) begin
		ledRGB_2_r_period_storage[31:0] <= csrbank4_r_period0_r;
	end
	ledRGB_2_r_period_re <= csrbank4_r_period0_re;
	if (csrbank4_g_enable0_re) begin
		ledRGB_2_g_enable_storage <= csrbank4_g_enable0_r;
	end
	ledRGB_2_g_enable_re <= csrbank4_g_enable0_re;
	if (csrbank4_g_width0_re) begin
		ledRGB_2_g_width_storage[31:0] <= csrbank4_g_width0_r;
	end
	ledRGB_2_g_width_re <= csrbank4_g_width0_re;
	if (csrbank4_g_period0_re) begin
		ledRGB_2_g_period_storage[31:0] <= csrbank4_g_period0_r;
	end
	ledRGB_2_g_period_re <= csrbank4_g_period0_re;
	if (csrbank4_b_enable0_re) begin
		ledRGB_2_b_enable_storage <= csrbank4_b_enable0_r;
	end
	ledRGB_2_b_enable_re <= csrbank4_b_enable0_re;
	if (csrbank4_b_width0_re) begin
		ledRGB_2_b_width_storage[31:0] <= csrbank4_b_width0_r;
	end
	ledRGB_2_b_width_re <= csrbank4_b_width0_re;
	if (csrbank4_b_period0_re) begin
		ledRGB_2_b_period_storage[31:0] <= csrbank4_b_period0_r;
	end
	ledRGB_2_b_period_re <= csrbank4_b_period0_re;
	...
	if (csrbank5_out0_re) begin
		leds_storage[15:0] <= csrbank5_out0_r;
	end
	...
	xilinxmultiregimpl1_regs0 <= {sw15, sw14, sw13, sw12, sw11, sw10, sw9, sw8, sw7, sw6, sw5, sw4, sw3, sw2, sw1, sw0};
...
//------------------------------------------------------------------------------
// Memory rom: 6079-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-06-22 07:35:56.
//------------------------------------------------------------------------------
