...
#			cpu_type="vexriscv",
		...
		user_leds = Cat(*[platform.request("led", i) for i in range(16)]) # Estaba en 10 y por eso no prendian todos
		self.submodules.leds = gpio.GPIOOut(user_leds)

		# Switchs
		SoCCore.add_csr(self,"switchs")
		user_switchs = Cat(*[platform.request("sw", i) for i in range(16)]) # Estaba en 8 y por eso no servian todos
